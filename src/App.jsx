      ...
      <section id="projects" className="py-32 px-8 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {projects.map((project, i) => (
            ...
            >
              <div className={`h-80 rounded-3xl p-8 backdrop-blur-xl border border-white/10 hover:border-${project.color}-400/50 hover:bg-${project.color}-500/5 transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl hover:shadow-${project.color}-500/20`}>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.slice(0,3).map(tech => (
                    <span key={tech} className={`px-3 py-2 bg-${project.color}-500/20 text-${project.color}-300 rounded-xl text-sm font-semibold border border-${project.color}-500/30`}>
                      {tech}
                    </span>
                  ))}
                </div>
